...
import { MatchCategoryPipe } from './wunschliste/category-filter.pipe';
import { SummaryPipe } from './wunschliste/summary.pipe';
import { WunschzettelService } from './service/index';
